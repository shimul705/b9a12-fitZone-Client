...
const NavBar = () => {
  ...
  const avatar =
    <>
      <div className="flex-shrink-0 group block " data-tip={user?.displayName || 'Name not found or please reload'}>

      {user && user.photoURL && user.photoURL !== 'photoURL not found' ? (
        <div className="flex items-center">
          <img
            className="inline-block flex-shrink-0 size-[62px] rounded-full" src={user.photoURL} alt="Image Description"
          />
          <div className="ms-3">
